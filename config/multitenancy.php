...
return [
     ...
     *
     */
    'tenant_finder' => App\Services\Tenants\OriginTenantFinder::class,
     ...
     */
    'switch_tenant_tasks' => [
        // Database switching handled by custom Tenant::makeCurrent() method
        // (We use separate credentials per tenant, so built-in task is not used)
