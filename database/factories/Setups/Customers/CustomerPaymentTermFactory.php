...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\Setups\Customers\CustomerPaymentTerm>
 */
class CustomerPaymentTermFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        $descriptions = [
            'Standard payment terms for customers',
