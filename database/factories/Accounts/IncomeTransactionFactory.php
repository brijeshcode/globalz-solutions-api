...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\Accounts\IncomeTransaction>
 */
class IncomeTransactionFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'subject' => fake()->optional(0.8)->randomElement($incomeSubjects),
    ...
    /**
     * Indicate that the transaction is for travel incomes.
     */
    public function travelIncome(): static
    {
        return $this->state(fn (array $attributes) => [
            'subject' => 'Business Travel Income',
            'amount' => fake()->randomFloat(2, 200, 5000),
            'note' => 'Business travel incomes including accommodation, meals, and transportation.',
        ]);
    }

    /**
     * Indicate that the transaction is a large income.
     */
