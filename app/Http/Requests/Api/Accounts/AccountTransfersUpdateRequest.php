...
class AccountTransfersUpdateRequest extends FormRequest
{
    /**
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            if ($this->input('from_account_id')) {
                $fromAccount = \App\Models\Accounts\Account::find($this->input('from_account_id'));
            ...
            if ($this->input('to_account_id')) {
                $toAccount = \App\Models\Accounts\Account::find($this->input('to_account_id'));
