...
class CommissionTargetsUpdateRequest extends FormRequest
{
    /**
    ...
    {
        $commissionTargetId = $this->route('commissionTarget')?->id;
        ...
        return [
            ...
            'name' => [
                ...
                'string',
                'max:50',
                Rule::unique('commission_targets', 'name')->ignore($commissionTargetId)
            ],
