...
class PurchaseReturnsStoreRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->merge([
            ...
            'additional_charge_amount' => $this->additional_charge_amount ?? 0,
            'additional_charge_amount_usd' => $this->additional_charge_amount_usd ?? 0,
        ]);
    }
}
