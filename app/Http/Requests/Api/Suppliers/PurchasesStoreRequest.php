...
class PurchasesStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'shipping_fee_usd_percent' => 'nullable|numeric|min:0|max:1000',
            'customs_fee_usd_percent' => 'nullable|numeric|min:0|max:1000',
            'other_fee_usd_percent' => 'nullable|numeric|min:0|max:1000',
