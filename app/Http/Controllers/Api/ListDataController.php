...
class ListDataController extends Controller
{
    ...
    {
        return Currency::with('activeRate:id,currency_id,rate')->active()->orderby('name')->get(['id', 'name', 'code', 'symbol'])
        ;
    }
    ...
    {
        return Supplier::active()->orderby('name')->get(['id', 'name', 'email', 'phone']);
    }
