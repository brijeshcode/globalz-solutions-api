...
class CustomerReturnResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'subtotal_taxable_amount' => $this->subtotal_taxable_amount,
            'subtotal_taxable_amount_usd' => $this->subtotal_taxable_amount_usd,
            ...
            'items' => $this->whenLoaded('items', function () {
                return $this->items->map(function ($item) {
                    return [
                        ...
                        'unit_taxable_amount' => $item->unit_taxable_amount,
                        'unit_taxable_amount_usd' => $item->unit_taxable_amount_usd,
                        'total_taxable_amount' => $item->total_taxable_amount,
                        'total_taxable_amount_usd' => $item->total_taxable_amount_usd,
                        'total_tax_amount' => $item->total_tax_amount,
                        'total_tax_amount_usd' => $item->total_tax_amount_usd,
