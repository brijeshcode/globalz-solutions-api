...
/**
 * @mixin \App\Models\Customers\Sale
 */
        ...
        return [
            ...
            'customer' => $this->whenLoaded('customer', function () {
                return [
                    ...
                    'mof_tax_number' => $this->when(filled($this->customer->mof_tax_number), $this->customer->mof_tax_number),
                ];
            }),
            ...
            'items' => $this->whenLoaded('items', function () {
                return $this->items->map(function ($item) {
                    return [
                        ...
                        'unit_discount_amount_usd' => $item->unit_discount_amount_usd + 0,
                        'discount_amount' => $item->discount_amount + 0,
                        'discount_amount_usd' => $item->discount_amount_usd + 0,
                        'net_sell_price' => $item->net_sell_price + 0,
                        'net_sell_price_usd' => $item->net_sell_price_usd + 0,
                        'tax_percent' => $item->tax_percent + 0,
                        'tax_label' => $item->tax_label,
                        'tax_amount' => $item->tax_amount + 0,
                        'tax_amount_usd' => $item->tax_amount_usd + 0,
                        'total_tax_amount' => $item->total_tax_amount + 0,
                        'total_tax_amount_usd' => $item->total_tax_amount_usd + 0,
                        'ttc_price' => $item->ttc_price + 0,
                        'ttc_price_usd' => $item->ttc_price_usd + 0,
                        'total_net_sell_price' => $item->total_net_sell_price + 0,
                        'total_net_sell_price_usd' => $item->total_net_sell_price_usd + 0,
                        'total_price' => $item->total_price + 0,
                        'total_price_usd' => $item->total_price_usd + 0,
                        'unit_profit' => $item->unit_profit + 0,
                        'total_profit' => $item->total_profit + 0,
                        'unit_volume_cbm' => $item->unit_volume_cbm + 0,
                        'unit_weight_kg' => $item->unit_weight_kg + 0,
                        'total_volume_cbm' => $item->total_volume_cbm + 0,
