...
class ItemAdjustItem extends Model
{
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($itemAdjustItem) {
            if (!$itemAdjustItem->item_code && $itemAdjustItem->item) {
                $itemAdjustItem->item_code = $itemAdjustItem->item->code;
            }
        });
    }
}
